...
<?php
					$rss = new DOMDocument();
	$rss->load('http://news.sky.com/feeds/rss/home.xml');
	$feed = array();
...
?>
				...
				<footer>
					<h3>Sky News Twitter</h3>
					
				<a class="twitter-timeline" href="https://twitter.com/SkyNews" data-widget-id="276804624416116737">Tweets by @SkyNews</a>
